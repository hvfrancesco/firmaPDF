...
public class PdfStamperOSP {
    ...
    private PdfSignatureAppearanceOSP sigApp;
     ...
     */
    public PdfStamperOSP(PdfReader reader, OutputStream os) throws DocumentException, IOException {
     ...
     * @throws IOException on error
     */
    public PdfStamperOSP(PdfReader reader, OutputStream os, char pdfVersion) throws DocumentException, IOException {
     ...
     * @throws IOException on error
     */
    public PdfStamperOSP(PdfReader reader, OutputStream os, char pdfVersion, boolean append) throws DocumentException, IOException {
     ...
     */    
    public PdfSignatureAppearanceOSP getSignatureAppearance() {
        return sigApp;
    }
...
//    }
     ...
     * @throws IOException on error
     */
    public static PdfStamperOSP createSignature(PdfReader reader, OutputStream os, char pdfVersion, File tempFile, boolean append) throws DocumentException, IOException {
        PdfStamperOSP stp;
        if (tempFile == null) {
            ByteBuffer bout = new ByteBuffer();
            stp = new PdfStamperOSP(reader, bout, pdfVersion, append);
            stp.sigApp = new PdfSignatureAppearanceOSP(stp.stamper);
            ...
            stp = new PdfStamperOSP(reader, fout, pdfVersion, append);
            stp.sigApp = new PdfSignatureAppearanceOSP(stp.stamper);
     ...
     * @return a <CODE>PdfStamper</CODE>
     */
    public static PdfStamperOSP createSignature(PdfReader reader, OutputStream os, char pdfVersion) throws DocumentException, IOException {
     ...
     * @throws IOException on error
     */
    public static PdfStamperOSP createSignature(PdfReader reader, OutputStream os, char pdfVersion, File tempFile) throws DocumentException, IOException 
    {
