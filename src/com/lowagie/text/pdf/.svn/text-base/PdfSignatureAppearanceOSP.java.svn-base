 ...
 */
public class PdfSignatureAppearanceOSP {
    ...
    PdfSignatureAppearanceOSP(PdfStamperImp writer) {
        this.writer = writer;
    ...
    */    
    ...
    private void addDocMDP(PdfDictionary crypto) {
         ...
         transformParams.put(PdfName.P, new PdfNumber(levelPermission));
    ...
    public InputStream getRangeStream() {
        return new PdfSignatureAppearanceOSP.RangeStream(raf, bout, range);
    }
     ...
     */    
    public com.lowagie.text.pdf.PdfStamperOSP getStamper() {
        return stamper;
    }
    
    void setStamper(com.lowagie.text.pdf.PdfStamperOSP stamper) {
    ...
    public boolean isCertified() {
        return (this.levelPermission > 0);
    }

    /**
     * Sets the document type to certified instead of simply signed. 
     * @param levelPermission <code>0</code> to just apply a simple signature> 
     * <code>1</code> apply a certified signature with permission -no changes-
     * <code>2</code> apply a certified signature with permission -form fill-in only-
     * <code>3</code> apply a certified signature with permission -form fill-in and commenting-
     */
    public void setCertified(int levelPermission) {
